package com.pfleaker.backend.repository;

import com.pfleaker.backend.PFleakerApp;

import com.pfleaker.backend.config.Constants;
import com.pfleaker.backend.config.audit.AuditEventConverter;
import com.pfleaker.backend.domain.PersistentAuditEvent;
...
import static com.pfleaker.backend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
